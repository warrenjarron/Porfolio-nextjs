...
let styles = {
  ...
  skills2p2:
    "text-center p-7 text-slate-500 sm:w-6/12  border-r-2 border-slate-500 md:mt-10 text-xl",
  ...
  imgPadding:
    "rounded-lg mt-10 hover:rotate-6 transition duration-150 hover:bg-slate-200",
  mail: "hover:text-yellow-200 ",
  Padding: " pt-5",
  Paddingnext:
    "pt-5 bg-white  hover:rotate-6 transition duration-150 hover:shadow-lg hover:shadow-yellow-200 p-5",
  ...
  compet:
    "text-slate-500 mt-52 text-7xl uppercase lg:text-7xl  justify-center p-5 hover:text-yellow-200",
  gridcol3P: "",
  footC:
    "text-slate-500 lg:grid lg:grid-cols-2 pb-20 text-center mt-10 hover:text-yellow-200 lg:ml-32 ",
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.col1}>
        ...
        <div className={styles.img}>
          <a
            href="https://github.com/warrenjarron"
            rel="noreferrer"
            target="_blank"
          >
            @WarrenJarron
        ...
        <div className={styles.img}>
          <a
            href="https://warren-jarron-cv.netlify.app/"
            rel="noreferrer"
            target="_blank"
          >
      ...
      <div className={styles.footC}>
        <div>
          <a className=" " href="mailto:warrenj.jarron@gmail.com">
            warrenj.jarron@gmail.com
          </a>
        </div>
        <div>
