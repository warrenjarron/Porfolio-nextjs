...
let styles = {
    h1: "  text-white font-montecarlo text-center md:text-5xl xs:text-6xl lg:text-7xl border-2 border-slate-500 p-5  lg:text-5xl ",
...
<Image src={warrenfly} width="400px" height="500px" className=""  />
</div>
<ParticlesAnimate/>
